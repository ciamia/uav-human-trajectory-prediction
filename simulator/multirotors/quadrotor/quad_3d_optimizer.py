...
from configs.configuration_parameters import GroundEffectMapConfig
from multirotors.quadrotor.quad_3d import Quadrotor3D
from utils.ground_map import GroundMapWithBox
...
class Quad3DOptimizer:
    ...
    def linearized_quad_dynamics(self):
        ...
        a_u = (self.u[0] + self.u[1] + self.u[2] + self.u[3]) * self.quad.max_thrust / self.quad.mv
